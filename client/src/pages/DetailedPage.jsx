...
{/* MAIN CONTENT */}
      ...
      <div className="mx-auto   items-center gap-x-8 gap-y-16  py-16 max-w-7xl grid-cols-2 px-8">
        <div>
          <h2 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-4xl">SkillMatch Dashboard</h2>
          ...
          <dl className="mt-16 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 sm:gap-y-16 lg:gap-x-8">
            ...
            {features.map((feature) => (
              <div key={feature.name} className="border-t  border-gray-400 pt-4">
                <dt className="font-medium text-xl text-[#007bff]">{feature.name}</dt>
